...
namespace LocadoraVeiculo.Tests.CondutorModule
{
    ...
    public class CondutorTest
    {
        ...
        public void DeveValidar_Nome()
        {
            ...
            var condutor = new Condutor("", "(49)12345-6789", "Coral", "011.900.119-57",
        ...
        public void DeveValidar_Endereco()
        {
            //arrange
            var cliente = new Cliente("Gabriel Marques", "Guarujá", "(49)99803-5074", "01190011956", "PF");
            var condutor = new Condutor("Pedro", "(49)12345-6789", "", "011.900.119-57",
                                        "6.187.754", "12345678910", new DateTime(2022, 06, 22), cliente);
        ...
        public void DeveValidar_Telefone()
        {
            //arrange
            var cliente = new Cliente("Gabriel Marques", "Guarujá", "(49)99803-5074", "01190011956", "PF");
            var condutor = new Condutor("Pedro", "(49)12345-67899", "Coral", "011.900.119-57",
                                        "6.187.754", "12345678910", new DateTime(2022, 06, 22), cliente);
        ...
        public void DeveValidar_CPF()
        {
            //arrange
            var cliente = new Cliente("Gabriel Marques", "Guarujá", "(49)99803-5074", "01190011956", "PF");
            var condutor = new Condutor("Pedro", "(49)12345-6789", "Coral", "011.900.119-577",
                                        "6.187.754", "12345678910", new DateTime(2022, 06, 22), cliente);
